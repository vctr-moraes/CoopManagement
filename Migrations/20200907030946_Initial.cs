        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Grau = table.Column<string>(type: "varchar(100)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgaoExpedidorRg = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
                    DataExpedicaoRg = table.Column<DateTime>(type: "date", nullable: false),
                    Naturalidade = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Nacionalidade = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    NomePai = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    NomeMae = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    RendaFamiliar = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
                    Matricula = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    CursoId = table.Column<Guid>(nullable: false),
                    Turma = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    ...
                    TelefoneResidencial = table.Column<string>(type: "varchar(20)", nullable: true),
                    TelefoneCelular = table.Column<string>(type: "varchar(20)", nullable: false),
                    ...
                    CotaParte = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
